...
public class PhysicsEngine {
	...
	/**
	 * Create the jbox2d world, manage collision and enemies behavior 
	 */
	private static final World world = new World(new Vec2(0, 0));

	/**
	 * Get the world
	 * @return the world with it carateristic
	 */
	...
	/**
	 * The TIE behavior
	 * @param tie, the TIE spaceship
	 * @param positionHero, the position of the hero for fire
	 */
	...
	/**
	 * The Croiser behavior
	 * @param croiser, the croiser spaceship
	 * @param hero, the hero spacesphip
	 */
	...
	/**
	 * The Fantacin behavior
	 * @param croiser, the fantacin spaceship
	 * @param hero, the hero spacesphip
	 */
